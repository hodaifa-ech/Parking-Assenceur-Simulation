...
public class AscenseurGraphic {
	...
	private void initialize() {
		...
		frameOfAscenseur.getContentPane().setBackground(new Color(100, 153, 153)); // Couleur du fond
		...
		panel_1.setBackground(new Color(200, 204, 204)); // Couleur du panneau 1
		panel_1.setBounds(10, 23, 5, 673);
		frameOfAscenseur.getContentPane().add(panel_1);

		JPanel panel_2 = new JPanel();
		panel_2.setBackground(new Color(200, 204, 204)); // Couleur du panneau 2
		...
		panel_10.setBackground(new Color(51, 100, 123)); // Couleur du panneau 10
		...
		principal.setBackground(new Color(120, 204, 100)); // Couleur du panneau principal
		...
		ascenseur2.setBorder(new LineBorder(new Color(0, 0, 0), 2));
		ascenseur2.setBackground(new Color(130, 100, 102)); // Couleur de l'ascenseur 2
		...
		panel_11.setBackground(new Color(130, 100, 102));
		...
		ascenseur1.setBorder(new LineBorder(new Color(0, 0, 0), 2));
		ascenseur1.setBackground(new Color(130, 100, 102)); // Couleur de l'ascenseur 1
		...
		panel_9.setBackground(new Color(200, 51, 51));



		JPanel panelImm = new JPanel();
		panelImm.setBackground(new Color(100, 100, 100)); // Couleur du panneau Imm
		panelImm.setToolTipText("");
		panelImm.setBorder(new LineBorder(new Color(0, 0, 0), 2));
		...
		panel_3.setBackground(new Color(100, 200, 1));
		...
		ImageIcon image2 = new ImageIcon("src/icon/icons8-employé-48.png");
		per4.setIcon(image2);
		panelImm.add(per4);

		JLabel per3 = new JLabel("");
		per3.setBounds(210, 110, 45, 50);
		ImageIcon image9 = new ImageIcon("src/icon/icons8-garçon-40.png");
		per3.setIcon(image9);
		panelImm.add(per3);

		JLabel per2 = new JLabel("");
		per2.setBounds(210, 210, 45, 41);
		ImageIcon image10 = new ImageIcon("src/icon/icons8-garçon-48.png");
		per2.setIcon(image10);
		panelImm.add(per2);

		JLabel per1 = new JLabel("");
		per1.setBounds(210, 310, 45, 50);
		ImageIcon image11 = new ImageIcon("src/icon/icons8-homme-48.png");
		...
		btnNewButton.setBackground(new Color(100, 200, 100));
		btnNewButton.setForeground(new Color(100, 200, 100));
